...
fem-ii_client: FemClientTest.cpp Fem2ControlMsg.cpp MsgPackEncoder.cpp
	$(CC_dyn) -o fem-ii_client FemClientTest.cpp Fem2ControlMsg.cpp MsgPackEncoder.cpp -DMSGPACK_USE_BOOST -I/u/dbu19518/develop/projects/xilinx/target/usr/include -L/u/dbu19518/develop/projects/xilinx/target/usr/lib -lzmq -lboost_date_time

fem-ii_server: FemServerTest.cpp Fem2ControlMsg.cpp MsgPackEncoder.cpp
	$(CC_dyn) -o fem-ii_server FemServerTest.cpp Fem2ControlMsg.cpp MsgPackEncoder.cpp -DMSGPACK_USE_BOOST -I/u/dbu19518/develop/projects/xilinx/target/usr/include -L/u/dbu19518/develop/projects/xilinx/target/usr/lib -lzmq -lboost_date_time